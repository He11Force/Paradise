...
\
Её навыками было спроектировано несколько важнейших объектов Синдиката. Ее стремление идти вперед, создавать не взирая на законы и запреты, \
собственной рукой творить реальность породили то, что мы видим вокруг. Много раз оступаясь, сражаясь с консерваторами и ретроградами, \
противниками прогресса, клинком, словом, знанием и делом она прорубила проход в будущее. Не забудем, не предадим твоих идей. Никогда..."
	icon = 'icons/obj/statuelarge.dmi'
	icon_state = "furukai"
	anchored = TRUE
	oreAmount = 0
